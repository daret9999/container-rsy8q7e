...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rsy8q7e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rsy8q7e.containers.anotherwebservice.com/
...
```
git clone git@github.com:daret9999/container-rsy8q7e.git
cd container-rsy8q7e
```
...
```
docker attach container-rsy8q7e
```
